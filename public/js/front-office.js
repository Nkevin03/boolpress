  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/posts?page=".concat(page)).then(function (res) {
        console.log(res); // Senza paginazione
            ...
            [
              _vm._l(_vm.posts, function (post) {
                return _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _c("p", [
                      _vm._v(_vm._s(_vm.getExcerpt(post.content, 100))),
                    ]),
                  ]
                )
              }),
              ...
              _c(
                "button",
                {
                  ...
                  attrs: { disable: _vm.pagination.current === 1 },
                  on: {
              ...
              _c(
                "button",
                {
                  ...
                  attrs: {
                    disable: _vm.pagination.current === _vm.pagination.last,
                  },
                  on: {
                    click: function ($event) {
                      return _vm.getPosts(_vm.pagination.current + 1)
